...
const curatedCompanies: Record<string, CompanyMeta> = {
  ...
  ByteDance: { name: 'ByteDance (Seed)', origin: 'China', accent: '#00d2c4', blurb: 'Familia Seed y Doubao. Modelos especializados en código y razonamiento agéntico.' },
...
const pyByteDance = (model: string) => `from openai import OpenAI
...
resp = client.chat.completions.create(
    model="${model}",
    messages=[{"role": "user", "content": "Diseña un pipeline ETL en Python y SQL"}],
)
print(resp.choices[0].message.content)`;
...
const rawModels: Model[] = [
  // ── Anthropic ──────────────────────────────────────────────────────────
  {
    ...
    context: 1_000_000,
    pricing: { inputPer1M: 5, outputPer1M: 25, currency: 'USD', note: 'Fast Mode disponible a 2× precio para menor latencia.' },
    ...
    videos: [
      ...
      { title: 'Claude Opus 5 vs GPT-5.6 Sol: batalla de agentes 2026', url: 'https://www.youtube.com/results?search_query=claude+opus+5+vs+gpt+5.6+sol+coding', source: 'YouTube' },
    ],
    notes: 'Modelo insignia de Anthropic (jul-2026). Líder global en coding y razonamiento agéntico (TerminalBench 89.1%, II 63.1). Contexto 1M, razonamiento adaptativo y Fast Mode.',
    benchmarks: { sweBenchPro: 79.4, terminalBench: 89.1, sciCode: 55.7, intelligenceIndex: 63.1 },
  },
  {
    id: 'claude-sonnet-5',
    company: 'Anthropic', origin: 'US', kind: 'model',
    ...
    category: ['coding', 'reasoning', 'agentic', 'general'],
    context: 1_000_000,
    ...
    playgroundUrl: 'https://console.anthropic.com/workbench',
    docsUrl: 'https://docs.claude.com',
    examples: [{ lang: 'python', title: 'SDK Python', code: pyAnthropic('claude-sonnet-5') }],
    videos: [
      { title: 'Claude Sonnet 5: el nuevo caballo de batalla para programar', url: 'https://www.youtube.com/results?search_query=claude+sonnet+5+coding+review+2026', source: 'YouTube' },
    ],
    notes: 'El nuevo estándar de desarrollo diario. Capacidad agéntica frontera a un tercio del coste de Opus (2$/10$ por 1M). Contexto 1M tokens.',
    benchmarks: { terminalBench: 80.5, sciCode: 53.6, intelligenceIndex: 55.3 },
  },
  {
    id: 'claude-fable-5',
    company: 'Anthropic', origin: 'US', kind: 'model',
    ...
    context: 1_000_000,
    pricing: { inputPer1M: 10, outputPer1M: 50, currency: 'USD' },
    modalities: ['text', 'image'],
    releaseDate: '2026-06-09',
    apiModelString: 'claude-fable-5',
    playgroundUrl: 'https://console.anthropic.com/workbench',
    docsUrl: 'https://docs.claude.com',
    examples: [{ lang: 'python', title: 'SDK Python', code: pyAnthropic('claude-fable-5') }],
    videos: [
      { title: 'Claude Fable 5: razonamiento científico y matemático extremo', url: 'https://www.youtube.com/results?search_query=claude+fable+5+scientific+reasoning', source: 'YouTube' },
    ],
    notes: 'Modelo de Anthropic especializado en razonamiento ultraprofundo, investigación científica y algorítmica de máxima dificultad (SciCode 60.2%).',
    benchmarks: { sciCode: 60.2, terminalBench: 84.6, intelligenceIndex: 62.1 },
  },
  {
    id: 'claude-opus-4-8',
    company: 'Anthropic', origin: 'US', kind: 'model',
    ...
    notes: 'Predecesor de Opus 5. Líder en SWE-bench Pro de la generación 4.x.',
  ...
  },
  {
    ...
    notes: 'Versión previa de Sonnet con contexto 1M y soporte maduro de tooling.',
  },
  {
    id: 'claude-haiku-4-5',
    company: 'Anthropic', origin: 'US', kind: 'model',
  ...
  // ── OpenAI ─────────────────────────────────────────────────────────────
  {
    ...
    docsUrl: 'https://developers.openai.com/api/docs/models/gpt-5.6',
    examples: [{ lang: 'python', title: 'SDK Python (Responses)', code: pyOpenAI('gpt-5.6-sol') }],
    videos: [
      { title: 'GPT-5.6 Sol Coding Demo — Análisis del nuevo flagship', url: 'https://www.youtube.com/results?search_query=gpt+5.6+sol+coding+demo+review+2026', source: 'YouTube' },
      { title: 'GPT-5.6 Sol vs Claude Opus 5 — Comparativa definitiva', url: 'https://www.youtube.com/results?search_query=gpt+5.6+sol+vs+claude+opus+5+comparison', source: 'YouTube' },
    ],
    notes: 'Modelo insignia de OpenAI (jul-2026). Integra razonamiento adaptativo, navegación autónoma de repositorios y orquestación de herramientas con 88% en TerminalBench.',
    benchmarks: { terminalBench: 88.0, sciCode: 56.1, intelligenceIndex: 60.9 },
  },
  {
    id: 'gpt-5-6-terra',
    company: 'OpenAI', origin: 'US', kind: 'model',
    ...
    playgroundUrl: 'https://platform.openai.com/playground',
    docsUrl: 'https://developers.openai.com/api/docs/models/gpt-5.6',
    examples: [{ lang: 'python', title: 'SDK Python', code: pyOpenAI('gpt-5.6-terra') }],
    videos: [
      { title: 'GPT-5.6 Terra: rendimiento flagship a un tercio del precio', url: 'https://www.youtube.com/results?search_query=gpt+5.6+terra+review+coding', source: 'YouTube' },
    ],
    notes: 'Modelo equilibrado para entornos de producción de alto rendimiento (88.0% en TerminalBench a 2$/12$ por 1M).',
    benchmarks: { terminalBench: 88.0, sciCode: 53.9, intelligenceIndex: 56.6 },
  },
  {
    id: 'gpt-5-6-luna',
    company: 'OpenAI', origin: 'US', kind: 'model',
    ...
    category: ['fast', 'budget', 'coding'],
    context: 1_000_000,
    pricing: { inputPer1M: 0.2, outputPer1M: 1.2, currency: 'USD' },
    modalities: ['text', 'image'],
    releaseDate: '2026-07-09',
    apiModelString: 'gpt-5.6-luna',
    playgroundUrl: 'https://platform.openai.com/playground',
    docsUrl: 'https://developers.openai.com/api/docs/models/gpt-5.6',
    examples: [{ lang: 'python', title: 'SDK Python', code: pyOpenAI('gpt-5.6-luna') }],
    videos: [
      { title: 'GPT-5.6 Luna: velocidad y coste mínimo para agentes', url: 'https://www.youtube.com/results?search_query=gpt+5.6+luna+budget+fast+coding', source: 'YouTube' },
    ],
    notes: 'La opción ultrarrápida y económica de la familia GPT-5.6 (0,20$/1,20$ por 1M). Gran rendimiento en TerminalBench (80.9%).',
    benchmarks: { terminalBench: 80.9, sciCode: 52.5, intelligenceIndex: 52.3 },
  },
  {
    id: 'gpt-5-5',
    company: 'OpenAI', origin: 'US', kind: 'model',
  ...
  // ── Google ─────────────────────────────────────────────────────────────
  {
    ...
    category: ['fast', 'coding', 'reasoning', 'multimodal'],
    context: 1_000_000,
    pricing: { inputPer1M: 0.375, outputPer1M: 1.875, currency: 'USD', note: 'Pensamiento híbrido graduable: razonamiento profundo o respuesta instantánea.' },
    modalities: ['text', 'image', 'audio', 'video'],
    releaseDate: '2026-08-01',
    apiModelString: 'gemini-3.7-flash',
    playgroundUrl: 'https://aistudio.google.com',
    docsUrl: 'https://ai.google.dev/gemini-api/docs',
    examples: [{ lang: 'typescript', title: 'SDK JS/TS', code: tsGoogle('gemini-3.7-flash') }],
    videos: [
      { title: 'Gemini 3.7 Flash: modelo híbrido con pensamiento dinámico', url: 'https://www.youtube.com/results?search_query=gemini+3.7+flash+coding+review+2026', source: 'YouTube' },
    ],
    notes: 'Modelo insignia híbrido de Google. Permite controlar el presupuesto de razonamiento (pensamiento extendido o directo) con soporte multimodal nativo y gran velocidad de generación.',
    benchmarks: { liveCodeBench: 81.2 },
  },
  {
    id: 'gemini-3-6-flash',
    company: 'Google', origin: 'US', kind: 'model',
    ...
    context: 1_000_000,
    pricing: { inputPer1M: 1.5, outputPer1M: 7.5, currency: 'USD' },
    modalities: ['text', 'image', 'audio', 'video'],
    releaseDate: '2026-07-21',
    apiModelString: 'gemini-3.6-flash',
    playgroundUrl: 'https://aistudio.google.com',
    docsUrl: 'https://ai.google.dev/gemini-api/docs',
    examples: [{ lang: 'typescript', title: 'SDK JS/TS', code: tsGoogle('gemini-3.6-flash') }],
    videos: [
      { title: 'Gemini 3.6 Flash: análisis para desarrollo y APIs', url: 'https://www.youtube.com/results?search_query=gemini+3.6+flash+review', source: 'YouTube' },
    ],
    notes: 'Rápido y multimodal con contexto 1M y soporte nativo de audio/vídeo (TerminalBench 77.5%).',
    benchmarks: { terminalBench: 77.5, sciCode: 52.7, intelligenceIndex: 51.6 },
  },
  {
    id: 'gemini-3-1-pro',
    company: 'Google', origin: 'US', kind: 'model',
  ...
  },
  {
    ...
    notes: 'Rápido y multimodal con contexto 1M. Buena alternativa con soporte nativo de audio y vídeo.',
  },
  {
    id: 'gemini-3-flash',
    company: 'Google', origin: 'US', kind: 'model',
  ...
  // ── xAI ────────────────────────────────────────────────────────────────
  {
    ...
    category: ['coding', 'reasoning', 'agentic'],
    context: 500_000,
    pricing: { inputPer1M: 2, outputPer1M: 6, currency: 'USD' },
    modalities: ['text', 'image'],
    releaseDate: '2026-08-12',
    apiModelString: 'grok-4.6',
    playgroundUrl: 'https://console.x.ai',
    docsUrl: 'https://docs.x.ai',
    examples: [{ lang: 'bash', title: 'API (OpenAI-compatible)', code: curlXAI('grok-4.6') }],
    videos: [
      { title: 'Grok 4.6: el nuevo salto en razonamiento y coding de xAI', url: 'https://www.youtube.com/results?search_query=grok+4.6+coding+review+2026', source: 'YouTube' },
    ],
    notes: 'Nuevo flagship de xAI (agosto 2026). Gran salto en razonamiento agéntico y depuración con 88.4% en TerminalBench e II 60.9.',
    benchmarks: { terminalBench: 88.4, sciCode: 53.6, intelligenceIndex: 60.9 },
  },
  {
    id: 'grok-4-5',
    company: 'xAI', origin: 'US', kind: 'model',
    ...
    playgroundUrl: 'https://console.x.ai',
    docsUrl: 'https://docs.x.ai',
    examples: [{ lang: 'bash', title: 'API (OpenAI-compatible)', code: curlXAI('grok-4.5') }],
    videos: [
      { title: 'Grok 4.5: review de rendimiento en desarrollo', url: 'https://www.youtube.com/results?search_query=grok+4.5+coding+benchmark', source: 'YouTube' },
    ],
    notes: 'Gran equilibrio precio/capacidad con contexto 500K y API OpenAI compatible.',
    benchmarks: { terminalBench: 81.6, sciCode: 54.1, intelligenceIndex: 55.8 },
  },
  {
    id: 'grok-3',
    company: 'xAI', origin: 'US', kind: 'model',
  ...
  // ── Meta ───────────────────────────────────────────────────────────────
  {
    ...
    category: ['coding', 'reasoning', 'agentic'],
    context: 500_000,
    pricing: { inputPer1M: 1.25, outputPer1M: 4.25, currency: 'USD' },
    modalities: ['text', 'image'],
    openWeight: true,
    releaseDate: '2026-08-05',
    apiModelString: 'meta-muse-spark-1.2',
    playgroundUrl: 'https://www.llama.com',
    docsUrl: 'https://www.llama.com/docs/',
    license: 'Llama Community',
    videos: [
      { title: 'Meta Muse Spark 1.2: nueva arquitectura open-weight para coding', url: 'https://www.youtube.com/results?search_query=meta+muse+spark+1.2+coding+review+2026', source: 'YouTube' },
    ],
    notes: 'Nueva generación open-weight de Meta para desarrollo y razonamiento. Gran desempeño en TerminalBench (80.1%) y SciCode (56.4%).',
    benchmarks: { terminalBench: 80.1, sciCode: 56.4, intelligenceIndex: 56.8 },
  },
  {
    id: 'muse-glimmer-30b',
    company: 'Meta', origin: 'Open', kind: 'model',
    displayName: 'Meta Muse Glimmer 30B',
    iiSlug: 'muse-glimmer-30b',
    category: ['budget', 'fast', 'coding'],
    context: 256_000,
    pricing: { inputPer1M: 0.35, outputPer1M: 1.5, currency: 'USD' },
    modalities: ['text'],
    openWeight: true,
    parameters: 30,
    releaseDate: '2026-08-01',
    apiModelString: 'meta-muse-glimmer-30b',
    playgroundUrl: 'https://www.llama.com',
    docsUrl: 'https://www.llama.com/docs/',
    license: 'Llama Community',
    videos: [
      { title: 'Muse Glimmer 30B: modelo ligero y rápido para self-hosting', url: 'https://www.youtube.com/results?search_query=meta+muse+glimmer+30b+review', source: 'YouTube' },
    ],
    notes: 'Modelo compacto de 30B parámetros optimizado para inferencia rápida, agentes ligeros y despliegue on-premise.',
  },
  {
    id: 'llama-4-maverick',
    company: 'Meta', origin: 'Open', kind: 'model',
  ...
  // ── China: DeepSeek ──────────────────────────────────────────────────────
  {
    ...
    category: ['coding', 'reasoning', 'agentic'],
    context: 128_000,
    pricing: { inputPer1M: 0.435, outputPer1M: 0.87, currency: 'USD' },
    modalities: ['text'],
    ...
    notes: 'Flagship MoE de 1.6T params, MIT license. Rendimiento frontera a coste ultra-reducido (0,435$/0,87$ por 1M) y 78.7% en TerminalBench.',
    benchmarks: { terminalBench: 78.7, sciCode: 49.2, intelligenceIndex: 53.0 },
  },
  {
  ...
  // ── China: Alibaba / Qwen ────────────────────────────────────────────────
  {
    ...
    videos: [
      { title: 'Qwen 3.8 Max: líder open-weight en reasoning y código', url: 'https://www.youtube.com/results?search_query=qwen+3.8+max+coding+reasoning+review+2026', source: 'YouTube' },
    ],
    notes: 'Nuevo flagship de Alibaba (agosto 2026). Gran mejora en razonamiento agéntico con TerminalBench 81.3% e II 58.1.',
    benchmarks: { terminalBench: 81.3, sciCode: 52.9, intelligenceIndex: 58.1 },
  },
  {
    id: 'qwen-3-8-27b',
    company: 'Alibaba', origin: 'China', kind: 'model',
    ...
    iiSlug: 'qwen3-8-27b',
    category: ['coding', 'budget', 'general'],
    context: 128_000,
    pricing: { inputPer1M: 0.45, outputPer1M: 3.2, currency: 'USD' },
    modalities: ['text'],
    openWeight: true,
    parameters: 27,
    releaseDate: '2026-08-01',
    apiModelString: 'qwen3.8-27b',
    playgroundUrl: 'https://chat.qwen.ai',
    docsUrl: 'https://www.alibabacloud.com/help/en/model-studio/',
    license: 'Apache-2.0',
    examples: [{ lang: 'python', title: 'SDK Python (OpenAI-compatible)', code: pyQwen('qwen3.8-27b') }],
    videos: [
      { title: 'Qwen 3.8 27B: el mejor modelo open-weight para workstation local', url: 'https://www.youtube.com/results?search_query=qwen+3.8+27b+coding+local', source: 'YouTube' },
    ],
    notes: 'Modelo open-weight Apache-2.0 de 27B parámetros ideal para ejecutar en local o servidores privados con gran potencia en código.',
  },
  {
    id: 'qwen-3-6-plus',
    company: 'Alibaba', origin: 'China', kind: 'model',
  ...
  // ── China: Zhipu / GLM ───────────────────────────────────────────────────
  {
    ...
    context: 1_000_000,
    pricing: { inputPer1M: 1.4, outputPer1M: 4.4, currency: 'USD' },
    modalities: ['text', 'image'],
    openWeight: true,
    ...
    notes: 'Actualización importante sobre GLM-5. Soporta contexto de 1M tokens nativo, líder en tool-calling open-weight (TerminalBench 77.9%).',
    benchmarks: { terminalBench: 77.9, sciCode: 50.5, intelligenceIndex: 52.6 },
  },
  {
    id: 'glm-5',
    company: 'Zhipu', origin: 'China', kind: 'model',
  ...
  // ── China: Moonshot / Kimi ───────────────────────────────────────────────
  {
    ...
    notes: 'MoE de 2.8T parámetros, open-weight. TerminalBench 85.0%, SciCode 58.7%, líder en Design Arena (código Elo >1400). Contexto 1M y razonamiento profundo.',
    benchmarks: { terminalBench: 85.0, sciCode: 58.7, intelligenceIndex: 59.7, designArenaElo: 1405 },
  },
  {
    id: 'kimi-k2-6',
    company: 'Moonshot', origin: 'China', kind: 'model',
  ...
  {
    id: 'seed-2-0-code',
    company: 'ByteDance', origin: 'China', kind: 'model',
    displayName: 'Seed 2.0 Code',
    iiSlug: 'seed-2-0-code',
    category: ['coding', 'agentic'],
    context: 256_000,
    pricing: { inputPer1M: 0.5, outputPer1M: 3.0, currency: 'USD' },
    modalities: ['text'],
    releaseDate: '2026-07-20',
    apiModelString: 'seed-2.0-code',
    playgroundUrl: 'https://www.volcengine.com/product/seed',
    docsUrl: 'https://www.volcengine.com/docs/82379',
    examples: [{ lang: 'python', title: 'SDK Python (OpenAI-compatible)', code: pyByteDance('seed-2.0-code') }],
    videos: [
      { title: 'Seed 2.0 Code: el modelo de código detrás de Trae IDE', url: 'https://www.youtube.com/results?search_query=seed+2.0+code+bytedance+trae', source: 'YouTube' },
    ],
    notes: 'Modelo de ByteDance especializado en generación de código, refactoring multi-archivo y flujos agénticos en IDEs.',
  },
  {
    id: 'seed-2-1-turbo',
    company: 'ByteDance', origin: 'China', kind: 'model',
    displayName: 'Seed 2.1 Turbo',
    iiSlug: 'seed-2-1-turbo',
    category: ['coding', 'fast', 'budget'],
    context: 256_000,
    pricing: { inputPer1M: 0.5, outputPer1M: 2.5, currency: 'USD' },
    modalities: ['text'],
    releaseDate: '2026-08-01',
    apiModelString: 'seed-2.1-turbo',
    playgroundUrl: 'https://www.volcengine.com/product/seed',
    docsUrl: 'https://www.volcengine.com/docs/82379',
    examples: [{ lang: 'python', title: 'SDK Python (OpenAI-compatible)', code: pyByteDance('seed-2.1-turbo') }],
    videos: [
      { title: 'Seed 2.1 Turbo: alta velocidad de inferencia para programación', url: 'https://www.youtube.com/results?search_query=seed+2.1+turbo+bytedance+coding', source: 'YouTube' },
    ],
    notes: 'Inferencia de baja latencia para autocompletado y agentes en tiempo real a coste económico.',
  },
  ...
  // ── China: Xiaomi / MiMo ─────────────────────────────────────────────────
  {
    ...
    apiModelString: 'mimo-v2.5-pro',
    docsUrl: 'https://github.com/XiaomiMiMo',
    license: 'Apache-2.0',
    videos: [
      { title: 'MiMo V2.5 Pro: líder de tokens en OpenRouter', url: 'https://www.youtube.com/results?search_query=mimo+v2.5+pro+xiaomi+coding+openrouter', source: 'YouTube' },
    ],
    notes: 'Uno de los líderes de tokens de coding en OpenRouter. Open-weight Apache-2.0 (TerminalBench 65.2%).',
    benchmarks: { terminalBench: 65.2, sciCode: 50.2 },
  },
...
const POPULARITY: Record<string, number> = {
  // Anthropic
  'claude-opus-5': 98, 'claude-sonnet-5': 94, 'claude-fable-5': 75,
  'claude-opus-4-8': 90, 'claude-sonnet-4-6': 85, 'claude-haiku-4-5': 70,
  // OpenAI
  'gpt-5-6-sol': 97, 'gpt-5-6-terra': 88, 'gpt-5-6-luna': 75,
  'gpt-5-5': 90, 'gpt-5-5-pro': 60, 'gpt-5-4': 74, 'gpt-5-3-codex': 80, 'gpt-4-1-nano': 65,
  // Google
  'gemini-3-7-flash': 92, 'gemini-3-6-flash': 82,
  'gemini-3-1-pro': 86, 'gemini-3-5-flash': 74, 'gemini-3-flash': 62, 'gemini-3-1-flash-lite': 55,
  // Microsoft
  'phi-4': 45, 'mai-code-1-flash': 40,
  // xAI
  'grok-4-6': 85, 'grok-4-5': 75, 'grok-3': 65, 'grok-3-mini': 48,
  // Meta
  'muse-spark-1-2': 78, 'muse-glimmer-30b': 62, 'llama-4-maverick': 66,
  // Mistral
  'mistral-large-3': 58, 'mistral-small': 50,
  // DeepSeek
  'deepseek-v4-pro': 89, 'deepseek-v4-flash': 82, 'deepseek-v3': 76,
  // Alibaba / Qwen
  'qwen-3-8-max': 88, 'qwen-3-8-27b': 74, 'qwen-3-6-plus': 82, 'qwen-3-5': 75,
  // Zhipu & Moonshot & ByteDance & MiniMax & Xiaomi
  'glm-5-2': 82, 'glm-5': 75,
  'kimi-k3': 86, 'kimi-k2-6': 68,
  'seed-2-0-code': 76, 'seed-2-1-turbo': 68,
  'minimax-m2-5': 68, 'mimo-v2-5-pro': 72,
  'ernie-5': 42, 'hunyuan-large': 38, 'step-3-5-flash': 30,
  // Herramientas / agentes
  'github-copilot': 90, 'cursor': 96, 'windsurf': 78, 'jules': 58,
  'opencode': 82, 'aider': 70, 'cline': 68,
  'claude-code': 94, 'codex-cli': 80, 'gemini-cli': 64, 'devin': 55,
  'zed': 60, 'amp': 45, 'roo-code': 58, 'trae': 55,
};
